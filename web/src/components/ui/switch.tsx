...
export const SwitchControl = <T extends ValidComponent = "div">(
  ...
  return (
    <SwitchPrimitive.Control
      ...
      class={cx(
        "bg-input inline-flex h-5 w-9 items-center rounded-full border border-transparent shadow-xs transition-all",
...
export const SwitchThumb = <T extends ValidComponent = "div">(
  ...
  return (
    <SwitchPrimitive.Thumb
      ...
      class={cx(
        "bg-background pointer-events-none size-4 rounded-full transition-transform data-[checked]:translate-x-[calc(100%-2px)]",
        props.class,
      )}
      {...rest}
    />
